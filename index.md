...
[`normal_block()`](reference/normal_block.md) function – known or
unknown clustering, sparse or not, zero-inflated or not are independent
choices, not separate model classes to learn.
