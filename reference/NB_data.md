...
- [`NB_data$new()`](#method-NB_data-new)

- [`NB_data$clone()`](#method-NB_data-clone)

------------------------------------------------------------------------

### Method `new()`

Create a new \[\`NB_data\`\] object.

#### Usage

    NB_data$new(Y, X, X0 = NULL, formula = NULL)
