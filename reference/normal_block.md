...
- data:
  ...
  NB_data object, contains the matrix of responses (Y, n x p) and the
  design matrix (X, n x d), must be created with NB_data\$new.
...
an R6 object with one of the NB classes (or a collection of NB objects).
