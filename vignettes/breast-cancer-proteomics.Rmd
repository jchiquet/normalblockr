...
When the clustering is left unknown, `normal_block()` accepts a range of candidate cluster counts and returns a collection of models, one per $q$, fitted independently.
