...
The plot function allows one to analyse each criterion as a function of the number of clusters and of the penalties. By default, the penalties to be tested are computed by the **normal-block** function for each number of clusters and they can be different from one number to another, this explains the blanks in the plot.
