...
`generate_normal_block_data()` generates data under the Normal-Block model. It returns a list containing the simulated covariates $X$ and observations $Y$, and the simulation parameters (including the clustering $C$).
