...
model. It returns a list that contains the simulated covariates $X$ and
observations $Y$, the simulation parameters (including the clustering
$C$).
...
A specific data object of class **NB_data** needs to be created to
...
#>       126 3       3        0 -6052.493 12104.99 12685.24 12709.46 12691.83
#>  niter
#>      7
#> ===========================================================================
#> * Useful fields
...
If one wants to use a fixed $l_{1}$ penalty (see Tous & Chiquet, 2024)
