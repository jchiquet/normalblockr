...
This part is the mathematical reference: for each variant, the generative
model, the criterion being optimized, and the explicit updates. Nothing here
depends on how any of it is computed; everything that does -- algebraic
shortcuts, caching, acceleration, initialization, solver choices -- is in
Part II.
...
Nothing in this part changes any model of Part I. It records how those
formulas are actually evaluated, which shortcuts are exact and which are
approximations, and the numerical traps found along the way.
